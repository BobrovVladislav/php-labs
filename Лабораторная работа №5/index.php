...
<body style="background-color: <?echo $_SESSION['user']['background']?>">
    <div class="container">
        <section>
            <card class="col-8 mx-auto">
                <h1 class="text-center">Личный кабинет</h1>
                <h2 class="text-center">Ваше имя: <? echo $_SESSION['user']['login'] ?></h2>

                <form class="card col-6 mx-auto p-3" action="changeSetting.php" method="POST">
